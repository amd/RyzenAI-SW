...
> {/* AUTO-GENERATED from tools/npu-check/README.md -- do not edit directly. */}
...
:::info Source Code
Clone the repo and find this example at [`examples/tools/npu-check/`](https://github.com/amd/RyzenAI-SW/tree/main/examples/tools/npu-check).
:::
