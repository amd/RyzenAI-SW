...
> {/* AUTO-GENERATED from audio/whisper/README.md -- do not edit directly. */}
...
:::info Source Code
Clone the repo and find this example at [`examples/audio/whisper/`](https://github.com/amd/RyzenAI-SW/tree/main/examples/audio/whisper).
:::
