...
> {/* AUTO-GENERATED from vision/hello_world/README.md -- do not edit directly. */}
...
:::info Source Code
Clone the repo and find this example at [`examples/vision/hello_world/`](https://github.com/amd/RyzenAI-SW/tree/main/examples/vision/hello_world).
:::
...
Note : Below commands work well in CMD and the Miniforge Prompt, users can also use other terminals with some modifications.
