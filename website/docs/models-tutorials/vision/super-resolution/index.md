...
> {/* AUTO-GENERATED from vision/super-resolution/README.md -- do not edit directly. */}
...
:::info Source Code
Clone the repo and find this example at [`examples/vision/super-resolution/`](https://github.com/amd/RyzenAI-SW/tree/main/examples/vision/super-resolution).
:::
