...
> {/* AUTO-GENERATED from vision/object_detection/yolov8s-worldv2/README.md -- do not edit directly. */}
...
:::info Source Code
Clone the repo and find this example at [`examples/vision/object_detection/yolov8s-worldv2/`](https://github.com/amd/RyzenAI-SW/tree/main/examples/vision/object_detection/yolov8s-worldv2).
:::
