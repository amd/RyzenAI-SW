...
> {/* AUTO-GENERATED from vision/getting_started_resnet/bf16/README.md -- do not edit directly. */}
...
For instructions to deploy the model using C++ APIs refer to [ResNet BF16 C++ Deployment](/models-tutorials/vision/getting-started-resnet/bf16/cpp-deployment)
