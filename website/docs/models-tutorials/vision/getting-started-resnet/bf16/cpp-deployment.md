...
> {/* AUTO-GENERATED from vision/getting_started_resnet/bf16/docs/README_C++.md -- do not edit directly. */}
...
:::info Source Code
Clone the repo and find this example at [`examples/vision/getting_started_resnet/bf16/`](https://github.com/amd/RyzenAI-SW/tree/main/examples/vision/getting_started_resnet/bf16).
:::
...
**Note:** Ensure that you are following the instructions for model and dataset setup and compilation from [BF16 setup](./)
...
The test images are generated from CIFAR-10 dataset, by extracting sample image from each classe. For more details refer to the ``prepare_test_images.py`` script.

###  Step 1:

```bash
cd <RyzenAI-SW>\CNN-examples\getting_started_resnet\bf16\app
build.bat
```
