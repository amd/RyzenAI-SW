...
> {/* AUTO-GENERATED from vision/quark_quantization/README.md -- do not edit directly. */}
...
:::info Source Code
Clone the repo and find this example at [`examples/vision/quark_quantization/`](https://github.com/amd/RyzenAI-SW/tree/main/examples/vision/quark_quantization).
:::
...
```powershell notest
cd <ryzenai-sw>\docs\models-tutorials\vision\quark_quantization
...
```bash
cd models && python download_ResNet.py 
```
