...
> {/* AUTO-GENERATED from vision/quark_quantization/docs/advanced_quant_readme.md -- do not edit directly. */}
...
Please ensure to setup the validation and calibration dataset using the instructions from [AMD Quark Quantization Tutorial](./)
...
```bash
cd models && python download_MobileNetV2.py 
```
