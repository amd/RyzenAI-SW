...
> {/* AUTO-GENERATED from vision/image_classification/README.md -- do not edit directly. */}
...
:::info Source Code
Clone the repo and find this example at [`examples/vision/image_classification/`](https://github.com/amd/RyzenAI-SW/tree/main/examples/vision/image_classification).
:::
