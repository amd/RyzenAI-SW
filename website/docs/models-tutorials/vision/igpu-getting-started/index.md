...
> {/* AUTO-GENERATED from vision/iGPU/getting_started/README.md -- do not edit directly. */}
...
:::info Source Code
Clone the repo and find this example at [`examples/vision/iGPU/getting_started/`](https://github.com/amd/RyzenAI-SW/tree/main/examples/vision/iGPU/getting_started).
:::
