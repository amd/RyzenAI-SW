...
> {/* AUTO-GENERATED from multimodal/npu-gpu-pipeline/README.md -- do not edit directly. */}
...
:::info Source Code
Clone the repo and find this example at [`examples/multimodal/npu-gpu-pipeline/`](https://github.com/amd/RyzenAI-SW/tree/main/examples/multimodal/npu-gpu-pipeline).
:::
...
```bat notest
rem Location of RyzenAI software installation path or default at "C:\Program Files\RyzenAI\<version>"
