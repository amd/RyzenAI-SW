...
> {/* AUTO-GENERATED from llms/llm-sft-deploy/README.md -- do not edit directly. */}
...
:::info Source Code
Clone the repo and find this example at [`examples/llms/llm-sft-deploy/`](https://github.com/amd/RyzenAI-SW/tree/main/examples/llms/llm-sft-deploy).
:::
...
We provide ``train.py`` to do LoRA finetuning. Training can be saved locally or directly to huggingface and wandB can be utilized to track training 
...
Use: ``inference.py`` to run inference on GPU . 
...
- Install Quark from wheel file [here](https://quark.docs.amd.com/latest/install.html#install-quark-quark-examples-from-download). 
