...
> {/* AUTO-GENERATED from llms/VLM/README.md -- do not edit directly. */}
...
:::info Source Code
Clone the repo and find this example at [`examples/llms/VLM/`](https://github.com/amd/RyzenAI-SW/tree/main/examples/llms/VLM).
:::
...
Refer to [OnnxRuntime GenAI (OGA)](/models-tutorials/llms/hybrid-inference) for more details. 
