...
> {/* AUTO-GENERATED from nlp/distilbert/README.md -- do not edit directly. */}
...
:::info Source Code
Clone the repo and find this example at [`examples/nlp/distilbert/`](https://github.com/amd/RyzenAI-SW/tree/main/examples/nlp/distilbert).
:::
