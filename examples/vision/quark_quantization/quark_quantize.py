...
from utils import ImageDataReader, evaluate_onnx_model, get_npu_info, get_xclbin
...
def main(args):
    ...
    if args.config == "XINT8":
        ...
        quant_config = get_default_config("A8W8")
    elif args.config == "A16W8":
        quant_config = get_default_config("A16W8")
    ...
    if args.evaluate:
        ...
        model_name = os.path.basename(output_model_path)[:-5]
        print('model_name:', model_name)
        if 'XINT8' in model_name:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, choices=["XINT8", "A8W8", "A16W8", "BF16"], default="XINT8", help='The model quantization configuration.')
    ...
    parser.add_argument('--benchmark', action='store_true', help='Flag to benchmasrk the model.')
