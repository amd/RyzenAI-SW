...
struct CVML_SDK_EXPORT_CORE Rect {
  /**
   * Default constructor.
   */
 ...
 */
template <typename _Tp>
struct CVML_SDK_EXPORT_CORE Point {
  /**
   * Default constructor.
   */
  Point() : x_(0), y_(0) {}
 ...
 */
template <typename _Tp>
struct CVML_SDK_EXPORT_CORE Point3 {
  /**
   * Default constructor.
   */
 ...
 */
template <typename _Tp>
struct CVML_SDK_EXPORT_CORE Quad {
  /**
   * Default constructor.
   */
  Quad() = default;
 ...
 */
template <class T>
class CVML_SDK_EXPORT_CORE Array {
 public:
  /**
   * Default constructor.
   */
 ...
 */
struct CVML_SDK_EXPORT_CORE Face {
  /// Constructor
