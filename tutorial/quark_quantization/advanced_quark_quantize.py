...
if __name__ == "__main__":
    ...
    parser.add_argument('--adaround', action='store_true', help='Use adaptive round quantization configuration.')
    parser.add_argument('--adaquant', action='store_true', help='Use adaptive quantization configuration.')
