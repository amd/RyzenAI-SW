...
parser.add_argument(
    ...
    help='Trained model file path. Download pretrained model from the following url and put it in model_dir specified path: https://download.pytorch.org/models/resnet50-19c8e357.pth'
)
parser.add_argument(
    '--config_file',
    default=None,
