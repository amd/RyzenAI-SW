...
from ultralytics.nn.tasks import (ClassificationModel, DetectionModel, SegmentationModel, attempt_load, attempt_load_one_weight,
                                  guess_model_task)
...
class YOLO:
    ...
    def _load(self, weights: str):
        ...
        self.model, self.ckpt = attempt_load(weights, force_reexport_deployable_model=self.trainer is None)
