...
from diffusers import OnnxRuntimeModel, OnnxStableDiffusionImg2ImgPipeline
...
def save_onnx_pipeline(
    ...
    onnx_pipeline = OnnxStableDiffusionImg2ImgPipeline(
...
def get_ort_pipeline_sd(model_dir, batch_size, image_size, provider, guidance_scale):
