...
class Resnet50:
    ...
    def postprocess(self, output):
        ...
        for k in indices[:5]:
            print("- Score: {:.8f}, Class: {}".format(res_list[k], classes[k]))
            with open("output.txt", "a") as f:
                f.write("- Score: {:.8f}, Class: {}\n".format(res_list[k], classes[k]))
        print("===========================================================")
    ...
    def run(self, args):
        ...
        """
        print("- Run Resnet50")
        print("- E2E Model (with pre/post processing): ", args.e2e_model)
        ...
        if args.e2e_model:
            model_path = os.path.join(
                current_path, "../models/resnet50_pt.v14.with_pre_processing.onnx"
            )
        else:
        ...
        for i in range(self.num_ep_iter):
            ...
            # Perform post-processing on the outputs to obtain Claasification labels.
