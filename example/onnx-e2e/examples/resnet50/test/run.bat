...
:HELPER
    ...
    echo     --with-pre                Run model containing the preprocessing node (Default: non-e2e model)
    echo     --e2e                     Run e2e model with pre and post processing (Default: non-e2e model)
    ...
    echo     --power-profile           Enable power profiling (Default :False)
    echo   ----------------------------------------------------------------------------------------
    echo %ESC%[0m
    goto :eof
