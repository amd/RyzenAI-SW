...
class PlaceholderOp : public Operation {
 public:
  ...
  TVM_DLL PlaceholderOp(std::string name, Array<PrimExpr> shape, DataType dtype, DLDeviceType device_type = kInvalidDeviceType);
 ...
 * \param device_type The device of the tensor.
 * \param name The name of the Tensor.
 */
TVM_DLL Tensor placeholder(Array<PrimExpr> shape, DataType dtype = DataType::Float(32),
                           std::string name = "placeholder", DLDeviceType device_type = kInvalidDeviceType);
