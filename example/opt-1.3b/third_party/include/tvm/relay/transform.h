 ...
 *
 *  NOTE: fold_quantize = true will ONLY fold qnn.quantize,
 *  because we want to use FakeQuantizationToInteger pass.
 *
 * \param fold_quantize Whether to fold constants for QNN quantize.
 * \return The pass.
 */
TVM_DLL Pass FoldConstant(bool fold_quantize = false);
