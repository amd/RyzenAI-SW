...
This guide contains all of the instructions necessary to get started with the model [`microsoft/Phi-3-mini-4k-instruct`](https://huggingface.co/microsoft/Phi-3-mini-4k-instruct) on Ryzen AI Hybrid in the int4 data type.
...
The Ryzen AI Hybrid implementation of [`microsoft/Phi-3-mini-4k-instruct`](https://huggingface.co/microsoft/Phi-3-mini-4k-instruct) uses the [`amd/Phi-3-mini-4k-instruct-awq-g128-int4-asym-fp16-onnx-hybrid`](https://huggingface.co/amd/Phi-3-mini-4k-instruct-awq-g128-int4-asym-fp16-onnx-hybrid) checkpoint on Hugging Face. This checkpoint has been quantized for int4 with AMD Quark using the recipe provided on the model card.
