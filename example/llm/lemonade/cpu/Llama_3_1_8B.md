...
This guide contains all of the instructions necessary to get started with the model [`meta-llama/Llama-3.1-8B`](https://huggingface.co/meta-llama/Llama-3.1-8B) on Hugging Face CPU in the bfloat16 data type.
...
The Hugging Face CPU implementation of [`meta-llama/Llama-3.1-8B`](https://huggingface.co/meta-llama/Llama-3.1-8B) uses the original safetensors weights provided in the Hugging Face checkpoint.
