...
This guide contains all of the instructions necessary to get started with the model [`microsoft/Phi-3-mini-4k-instruct`](https://huggingface.co/microsoft/Phi-3-mini-4k-instruct) on Hugging Face CPU in the bfloat16 data type.
...
The Hugging Face CPU implementation of [`microsoft/Phi-3-mini-4k-instruct`](https://huggingface.co/microsoft/Phi-3-mini-4k-instruct) uses the original safetensors weights provided in the Hugging Face checkpoint.
