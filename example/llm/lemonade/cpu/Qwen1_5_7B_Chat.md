...
This guide contains all of the instructions necessary to get started with the model [`Qwen/Qwen1.5-7B-Chat`](https://huggingface.co/Qwen/Qwen1.5-7B-Chat) on Hugging Face CPU in the bfloat16 data type.
...
The Hugging Face CPU implementation of [`Qwen/Qwen1.5-7B-Chat`](https://huggingface.co/Qwen/Qwen1.5-7B-Chat) uses the original safetensors weights provided in the Hugging Face checkpoint.
