# Hugging Face CPU: deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B (bfloat16)

This guide contains all of the instructions necessary to get started with the model `deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B` on Hugging Face CPU in the bfloat16 data type.
...
The Hugging Face CPU implementation of `deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B` uses the ONNX Runtime GenAI Model Builder tool, via `lemonade` to export an ONNX model for use in inference.
