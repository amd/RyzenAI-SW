...
parser.add_argument(
    ...
    '-m',
    metavar='NAME',
    default='RegNet_X_400MF_Weights.IMAGENET1K_V1',
    help='the weights in the original floating-point Torch model.')
...
def load_loader(weights_name, data_dir, batch_size, workers):
    weights = torchvision.models.get_weight(weights_name)
    preprocessing = weights.transforms()
    dataset = torchvision.datasets.ImageFolder(data_dir, preprocessing)
...
def main():
    ...
    if args.onnx_input:
        val_loader = load_loader(args.weights_name, args.data, args.batch_size,
                                 args.workers)
