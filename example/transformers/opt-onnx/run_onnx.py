...
if __name__ == "__main__":
    ...
    parser.add_argument('--quantize', help="quantize sing optimum onnx quantizer with avx512 backend", action='store_true')
    parser.add_argument('--check', help="compare poytorch, onnx, quantized-onnx outputs", action='store_true')
    ...
    if args.onnx:
        ...
        quantizer = ORTQuantizer.from_pretrained("./%s_smoothquant"%args.model_name + "/onnx", file_name="model.onnx")
