...
def find_lib_path(name=None, search_path=None, optional=False):
    ...
    if name is not None:
        ...
        if sys.platform.startswith("win32"):
            lib_dll_names = ["libtvm_ipu.dll", "tvm_ipu.dll"]
            runtime_dll_names = ["libtvm_ipu_runtime.dll", "tvm_ipu_runtime.dll"]
        elif sys.platform.startswith("darwin"):
            lib_dll_names = ["libtvm_ipu.dylib"]
            runtime_dll_names = ["libtvm_ipu_runtime.dylib"]
        else:
            lib_dll_names = ["libtvm_ipu.so"]
            runtime_dll_names = ["libtvm_ipu_runtime.so"]
...
__version__ = "0.15.dev0+aie.0.3.dev0"
