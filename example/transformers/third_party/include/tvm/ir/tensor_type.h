...
class TensorType : public Type {
 public:
   ...
   * \param device_type The device type. -1 corresponds to kInvalidDeviceType
   */
  TVM_DLL TensorType(Array<PrimExpr> shape, DataType dtype, DLDeviceType device_type = DLDeviceType{-1});
