...
:run_cpp_tests
    ...
    set "cpp_tests[0]=Qlinear_2Testw8a8*"
    set "cpp_tests[1]=Qlinear_2Testw8a16*"
...
:run_pytests
    ...
    @REM Additional STX tests
    set "pytest_tests[11]=--quant_mode w8a16 .\tests\python\test_qlinear.py"
    set "pytest_tests[12]=--quant_mode w8a16 .\tests\python\test_opt_flash_attention.py"
    set "pytest_tests[13]=--quant_mode w8a16 .\tests\python\test_llama_flash_attention.py"
