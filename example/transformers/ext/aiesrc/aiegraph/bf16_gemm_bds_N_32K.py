...
print(f"// MAX_M_SUBV: ", MAX_M_SUBV)
print(f"// MAX_K_SUBV: ", MAX_K_SUBV)
print(f"// MAX_N_SUBV: ", MAX_N_SUBV)
print(f"// MAX_GRP_SIZE: ", MAX_GRP_SIZE)
...
print(f"// IN1_REPEAT: ", IN1_REPEAT)
print(f"// IN2_REPEAT: ", IN2_REPEAT)
print(f"// OUT_REPEAT: ", OUT_REPEAT)
    ...
    memtile_transfers = [
        # Param 1 --> 1 core input 1
         DataTransfer(
             ...
             [1]+(([0]*OUTER_N_LOOP)*OUTER_M_LOOP)+([0]*(OUTER_M_LOOP-1)),
        ...
        # IFM 1 --> 1 core input 1
         ...
         DataTransfer(
             ...
             ([0]+[WGT_REPEAT]*(OUTER_N_LOOP))*OUTER_M_LOOP,
