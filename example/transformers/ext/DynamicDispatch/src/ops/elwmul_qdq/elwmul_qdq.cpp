...
template <typename InT, typename WtT, typename OutT>
std::tuple<int, int> elwmul_qdq<InT, WtT, OutT>::map_padded_shape(int M,
                                                                  int N) {
...
template <typename InT, typename WtT, typename OutT>
std::string elwmul_qdq<InT, WtT, OutT>::get_instr_key(std::string prefix, int m,
                                                      int k) {
...
elwmul_qdq<InT, WtT, OutT>::elwmul_qdq(
  ...
  default_shapes_["elwmul_qdq_4x2_abf16a16acc16"] =
      std::vector<std::tuple<int, int>>();
  default_shapes_["elwmul_qdq_4x4_abf16a16acc16"] =
      std::vector<std::tuple<int, int>>();

  default_shapes_["elwmul_qdq_4x2_abf16a16acc16"].push_back(
  ...
  raw_shapes_["elwmul_qdq_4x2_abf16a16acc16"] =
      std::vector<std::tuple<int, int>>();
  raw_shapes_["elwmul_qdq_4x4_abf16a16acc16"] =
      std::vector<std::tuple<int, int>>();

  raw_shapes_["elwmul_qdq_4x2_abf16a16acc16"].push_back(
      std::make_tuple(64, 5120));
  raw_shapes_["elwmul_qdq_4x2_abf16a16acc16"].push_back(
      std::make_tuple(256, 5120));
  raw_shapes_["elwmul_qdq_4x2_abf16a16acc16"].push_back(
...
void elwmul_qdq<InT, WtT, OutT>::initialize_const_params(
  ...
  DOD_THROW_IF(
      (const_params.size() != 1),
      OpsFusion::dod_format("Unsupported const spec for elwmul_qdq\n") +
...
template <typename InT, typename WtT, typename OutT>
void elwmul_qdq<InT, WtT, OutT>::execute(const std::vector<Tensor> &input,
