...
template <typename InT, typename WtT, typename OutT>
std::tuple<int, int> matvec_add<InT, WtT, OutT>::map_padded_shape(int M,
                                                                  int N) {
...
template <typename InT, typename WtT, typename OutT>
std::string matvec_add<InT, WtT, OutT>::get_instr_key(std::string prefix, int m,
                                                      int k) {
...
matvec_add<InT, WtT, OutT>::matvec_add(
  ...
  default_shapes_["matvecadd_4x2_a16a16acc16"] =
      std::vector<std::tuple<int, int>>();

  default_shapes_["matvecadd_4x2_a16a16acc16"].push_back(
  ...
  raw_shapes_["matvecadd_4x2_a16a16acc16"] =
      std::vector<std::tuple<int, int>>();

  raw_shapes_["matvecadd_4x2_a16a16acc16"].push_back(
      std::make_tuple(4096, 320));
  raw_shapes_["matvecadd_4x2_a16a16acc16"].push_back(
      std::make_tuple(256, 1280));
  raw_shapes_["matvecadd_4x2_a16a16acc16"].push_back(
      std::make_tuple(1024, 640));
  raw_shapes_["matvecadd_4x2_a16a16acc16"].push_back(std::make_tuple(64, 1280));
...
void matvec_add<InT, WtT, OutT>::initialize_const_params(
  ...
  DOD_THROW_IF((const_params.size() != 1),
               OpsFusion::dod_format("Unsupported const spec for matvecadd\n") +
...
template <typename InT, typename WtT, typename OutT>
void matvec_add<InT, WtT, OutT>::execute(const std::vector<Tensor> &input,
