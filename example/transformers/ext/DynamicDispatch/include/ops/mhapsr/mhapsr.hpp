...
class mhapsr : public OpInterface {
private:
  ...
  /* batch, head, x, y dimension of input to mhapsr*/
...
public:
  mhapsr(const std::string &a_dtype, const std::string &b_dtype,
