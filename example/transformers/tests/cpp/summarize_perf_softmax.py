...
def main():
    ...
    parser.add_argument(
        "--file", type=str, required=True, help="CSV file generated by silu"
    )
    ...
    with open(args.file) as file:
        ...
        for row in reader:
            ...
            if first_row:
                ...
                exe_per_shape.append(float(row[4]))
                aie_run_per_shape.append(float(row[6]))
                a_copy_per_shape.append(float(row[7]))
                a_sync_per_shape.append(float(row[8]))
                b_copy_per_shape.append(float(row[9]))
                b_sync_per_shape.append(float(row[10]))
                c_copy_per_shape.append(float(row[11]))
                c_sync_per_shape.append(float(row[12]))
