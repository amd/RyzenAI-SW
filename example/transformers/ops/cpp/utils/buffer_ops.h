...
static void init_hex_buf(int *buff, size_t bytesize, std::string &filename) {
...
static void init_hex_buf(xrt::bo &bo, size_t bytesize, std::string &filename) {
  init_hex_buf(bo.map<int *>(), bytesize, filename);
}

static size_t get_instr_size(std::string &fname) {
