...
1. **Install NPU drivers:** Follow the [RAI installation instructions](/getting-started/inst). Download and install the NPU driver (version 32.0.203.280 or newer) from the AMD Ryzen AI driver page.
