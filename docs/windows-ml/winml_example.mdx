...
The NPU driver and Windows App SDK should be correctly installed, as described in [Windows ML Installation](/windows-ml/installation).
...
- Original float model can be passed through automatic BF16 conversion. For more details refer to [Model conversion](/tools/model_quantization)
