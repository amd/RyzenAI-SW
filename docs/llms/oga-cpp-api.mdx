---
title: "OGA C++ API"
description: "OGA C++ API on AMD Ryzen AI."
---

{/* owner: dwithchenna */}

<Note>Source: [RyzenAI-SW / LLM-examples/oga_api](https://github.com/amd/RyzenAI-SW/blob/main/LLM-examples/oga_api). Code is maintained in the repository; this page mirrors its README.</Note>
...
- The steps for installing Ryzen AI along with it's requirement can be found in the Official Ryzen AI Software documantion page here - [Installation Instructions](/installation)
