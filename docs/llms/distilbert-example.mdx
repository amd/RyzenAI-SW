...
description: "DistilBERT Text Classification on AMD Ryzen AI."
---

{/* owner: dwithchenna */}

<Note>Source: [RyzenAI-SW / Transformer-examples/DistilBERT_text_classification_bf16](https://github.com/amd/RyzenAI-SW/blob/main/Transformer-examples/DistilBERT_text_classification_bf16). Code is maintained in the repository; this page mirrors its README.</Note>
