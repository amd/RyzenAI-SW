---
title: "Fine-tuned LLM Deployment"
description: "Fine-tuned LLM Deployment on AMD Ryzen AI."
---

{/* owner: dwithchenna */}

<Note>Source: [RyzenAI-SW / LLM-examples/llm-sft-deploy](https://github.com/amd/RyzenAI-SW/blob/main/LLM-examples/llm-sft-deploy). Code is maintained in the repository; this page mirrors its README.</Note>
...
### Quantize the full-precision, finetuned model using the quantization strategy menentioned [here](/llms/oga_model_prepare)

### Install RyzenAI and prerequisites accoring to instructions [here](/installation).

### Transform the quantized model to run on Hybrid approach within Ryzen AI, utilizing both the iGPU and NPU by running the following. See reference [here](/llms/oga_model_prepare).
