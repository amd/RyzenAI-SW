...
- Install NPU Drivers and Ryzen AI MSI installer. See [Installation Instructions](/installation) for more details.
...
A complete example including C++ source and build instructions is available in the [OGA C++ API](/llms/oga-cpp-api) tutorial.
