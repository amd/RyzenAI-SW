...
description: "Vision Language Models (VLM) on AMD Ryzen AI."
---

{/* owner: dwithchenna */}

<Note>Source: [RyzenAI-SW / LLM-examples/VLM](https://github.com/amd/RyzenAI-SW/blob/main/LLM-examples/VLM). Code is maintained in the repository; this page mirrors its README.</Note>
...
Refer to OnnxRuntime GenAI (OGA) for more details. 
...
Instructions for installing Ryzen AI and its requirements are available on the official Ryzen AI Software documentation page: [Installation Instructions](/installation)
