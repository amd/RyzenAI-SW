---
title: "Running Whisper on Ryzen AI"
ci_validated: false
---
...
| Model | Parameters | NPU Support |
|-------|-----------|-------------|
| [amd/whisper-base-onnx-npu](https://huggingface.co/amd/whisper-base-onnx-npu) | 74M | Yes |
| [amd/whisper-small-onnx-npu](https://huggingface.co/amd/whisper-small-onnx-npu) | 244M | Yes |
| [amd/whisper-medium-onnx-npu](https://huggingface.co/amd/whisper-medium-onnx-npu) | 769M | Yes |
| [amd/whisper-large-v3-turbo-onnx-npu](https://huggingface.co/amd/whisper-large-v3-turbo-onnx-npu) | 809M | Yes |
