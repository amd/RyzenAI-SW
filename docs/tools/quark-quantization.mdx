---
title: "Quark Quantization"
description: "Quark Quantization on AMD Ryzen AI."
---

{/* owner: dwithchenna */}

<Note>Source: [RyzenAI-SW / CNN-examples/quark_quantization](https://github.com/amd/RyzenAI-SW/blob/main/CNN-examples/quark_quantization). Code is maintained in the repository; this page mirrors its README.</Note>
...
```powershell
cd <ryzenai-sw>/docs/vision/quark_quantization
pip install -r requirements.txt
```
