...
The complete list of operations supported for different quantization types can be found in [Supported Operations](/tools/ops_support).
...
- Running INT8 model on NPU using [ResNet on Ryzen AI](/vision/getstartex)
