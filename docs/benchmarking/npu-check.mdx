---
title: "NPU Check"
description: "NPU Check on AMD Ryzen AI."
---

{/* owner: dwithchenna */}

<Note>Source: [RyzenAI-SW / utilities/npu_check](https://github.com/amd/RyzenAI-SW/blob/main/utilities/npu_check). Code is maintained in the repository; this page mirrors its README.</Note>
