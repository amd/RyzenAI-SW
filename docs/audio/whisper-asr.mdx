---
title: "Whisper ASR"
description: "Whisper ASR on AMD Ryzen AI."
---

{/* owner: dwithchenna */}

<Note>Source: [RyzenAI-SW / Demos/ASR/Whisper](https://github.com/amd/RyzenAI-SW/blob/main/Demos/ASR/Whisper). Code is maintained in the repository; this page mirrors its README.</Note>
...
1. **Install Ryzen AI Software** — follow the Installation guide.
