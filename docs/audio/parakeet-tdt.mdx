---
title: "Parakeet ASR"
description: "Parakeet ASR on AMD Ryzen AI."
---

{/* owner: lakshay048 */}

<Note>Source: [RyzenAI-SW / Demos/ASR/Parakeet-TDT](https://github.com/amd/RyzenAI-SW/blob/main/Demos/ASR/Parakeet-TDT). Code is maintained in the repository; this page mirrors its README.</Note>
...
Tested on 16.5 minutes of audio (RTF=0.023-0.030). See [OPTIMIZATION.md](https://github.com/amd/RyzenAI-SW/blob/main/Demos/ASR/Parakeet-TDT/OPTIMIZATION.md) for the full optimization journey.
