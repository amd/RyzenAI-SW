---
title: "Hello World"
description: "Hello World on AMD Ryzen AI."
---

{/* owner: dwithchenna */}

<Note>Source: [RyzenAI-SW / CNN-examples/hello_world](https://github.com/amd/RyzenAI-SW/blob/main/CNN-examples/hello_world). Code is maintained in the repository; this page mirrors its README.</Note>
...
Before running this example, ensure that you have followed the Ryzen AI Installation instructions found [here](/installation) and have activated the conda environment created during installation.
