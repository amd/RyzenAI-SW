---
title: "NPU + GPU Pipeline"
description: "NPU + GPU Pipeline on AMD Ryzen AI."
---

{/* owner: dwithchenna */}

<Note>Source: [RyzenAI-SW / Demos/NPU-GPU-Pipeline](https://github.com/amd/RyzenAI-SW/blob/main/Demos/NPU-GPU-Pipeline). Code is maintained in the repository; this page mirrors its README.</Note>
...
Install Ryzen AI Software using the automatic installer [Link](/installation). This should create a  conda environment that can be used for this example. Check the installation path variables
