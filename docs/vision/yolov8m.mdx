---
title: "Object Detection: YOLOv8m"
description: "Object Detection: YOLOv8m on AMD Ryzen AI."
---

{/* owner: dwithchenna */}

<Note>Source: [RyzenAI-SW / CNN-examples/object_detection/yolov8m](https://github.com/amd/RyzenAI-SW/blob/main/CNN-examples/object_detection/yolov8m). Code is maintained in the repository; this page mirrors its README.</Note>
...
```powershell
cd <RyzenAI-SW>/docs/vision/object_detection/yolov8m
pip install -r requirements.txt
```
...
![test_output_bf16](https://raw.githubusercontent.com/amd/RyzenAI-SW/main/CNN-examples/object_detection/yolov8m/results/test_output_bf16.png)
...
![test_output_int8](https://raw.githubusercontent.com/amd/RyzenAI-SW/main/CNN-examples/object_detection/yolov8m/results/test_output_int8.jpg)
...
![image](https://raw.githubusercontent.com/amd/RyzenAI-SW/main/CNN-examples/object_detection/yolov8m/results/yolov8m_quantized_concat_node.png)
...
![image](https://raw.githubusercontent.com/amd/RyzenAI-SW/main/CNN-examples/object_detection/yolov8m/results/yolov8m_skip_nodes.png)
...
![test_output_int8](https://raw.githubusercontent.com/amd/RyzenAI-SW/main/CNN-examples/object_detection/yolov8m/results/test_output_int8_skip_nodes.jpg)
