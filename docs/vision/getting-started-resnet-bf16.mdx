---
title: "Getting Started: ResNet (BF16)"
description: "Getting Started: ResNet (BF16) on AMD Ryzen AI."
---

{/* owner: dwithchenna */}

<Note>Source: [RyzenAI-SW / CNN-examples/getting_started_resnet/bf16](https://github.com/amd/RyzenAI-SW/blob/main/CNN-examples/getting_started_resnet/bf16). Code is maintained in the repository; this page mirrors its README.</Note>
...
For instructions to deploy the model using C++ APIs refer to [ResNet BF16 C++ Deployment](https://github.com/amd/RyzenAI-SW/blob/main/CNN-examples/getting_started_resnet/bf16/docs/README_C++.md)
