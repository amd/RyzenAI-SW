---
title: "Object Detection: YOLOv8s-World v2"
description: "Object Detection: YOLOv8s-World v2 on AMD Ryzen AI."
---

{/* owner: dwithchenna */}

<Note>Source: [RyzenAI-SW / CNN-examples/object_detection/yolov8s-worldv2](https://github.com/amd/RyzenAI-SW/blob/main/CNN-examples/object_detection/yolov8s-worldv2). Code is maintained in the repository; this page mirrors its README.</Note>
