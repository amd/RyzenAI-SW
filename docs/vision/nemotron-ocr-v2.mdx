...
description: "Nemotron OCR v2 on AMD Ryzen AI."
---

{/* owner: lakshay048 */}

<Note>Source: [RyzenAI-SW / CNN-examples/Nemotron-OCR-V2](https://github.com/amd/RyzenAI-SW/blob/main/CNN-examples/Nemotron-OCR-V2). Code is maintained in the repository; this page mirrors its README.</Note>
...
- Installation guide: [Installation Instructions](/installation)
...
The ONNX models are readily available for testing in the **Models** folder. However, if you want to convert the models from the original Hugging Face PyTorch versions, you can follow the steps below.
...
### 4. Model Compilation - [BF16](/tools/modelrun)

**Requirements:**

- A [vitisai_config.json](https://github.com/amd/RyzenAI-SW/blob/main/CNN-examples/Nemotron-OCR-V2/vitisai_config.json) configuration file is required 
...
```
  ...
  ![](https://raw.githubusercontent.com/amd/RyzenAI-SW/main/CNN-examples/Nemotron-OCR-V2/compare_output.png)
  

  CPU-FP32 vs NPU-BF16
...
This script runs the complete end-to-end OCR pipeline (detector, recognizer, and relational models) on both CPU and NPU, comparing performance and accuracy. Visualizes detection boxes, recognized text, and nearest-neighbor relationships, generating side-by-side comparisons. Outputs visualizations and JSON results (with extracted text, bounding boxes, confidence scores, and inference times) to the `./e2e_results` folder.
  ...
  ![](https://raw.githubusercontent.com/amd/RyzenAI-SW/main/CNN-examples/Nemotron-OCR-V2/recognizer_output.png)
  ...
  ![](https://raw.githubusercontent.com/amd/RyzenAI-SW/main/CNN-examples/Nemotron-OCR-V2/relational_output.png)
