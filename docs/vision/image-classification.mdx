...
description: "Image Classification on AMD Ryzen AI."
---

{/* owner: dwithchenna */}

<Note>Source: [RyzenAI-SW / CNN-examples/image_classification](https://github.com/amd/RyzenAI-SW/blob/main/CNN-examples/image_classification). Code is maintained in the repository; this page mirrors its README.</Note>
